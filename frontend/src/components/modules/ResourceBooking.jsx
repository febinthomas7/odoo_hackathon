...
const BookingModal = ({ assets, employees, onClose, onComplete, errorMsg, setErrorMsg }) => {
  const [formData, setFormData] = useState({ assetId: '', bookedBy: '', date: '', startTime: '', endTime: '' });
    ...
    <Modal title="Book a Resource" onClose={onClose}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select required value={formData.bookedBy} onChange={e => setFormData({...formData, bookedBy: e.target.value})} className="w-full bg-slate-800 border border-slate-700 text-white rounded-lg p-2.5 focus:ring-1 focus:ring-indigo-500">
